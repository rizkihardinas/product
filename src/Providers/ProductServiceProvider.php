...
class ProductServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->publishes([
            __DIR__.'/../../config/rizkihardinas-product.php' => config_path('rizkihardinas-product.php'),
        ], 'config');
    }
    protected function registerLivewireComponents()
    {
        // Product
        Livewire::component('product.list', \Rizkihardinas\Product\Http\Livewire\Product\ListProduct::class);
        ...
        // Barcode
        Livewire::component('barcode.list', \Rizkihardinas\Product\Http\Livewire\Barcode\ListBarcode::class);
